...
import { BeakerIcon, FlagIcon, PresentationChartLineIcon, UserGroupIcon, HeartIcon } from '@heroicons/react/solid'

const BusinessSummary = () => {
    return (
        <div className='py-12 px-6 md:px-12 lg:px-12'>
            <h1 className='text-blue-700 font-bold text-3xl'>Million of Business Trust Us</h1>
            <small className='mb-24'>Try to understant User Expection</small>
