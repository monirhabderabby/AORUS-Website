                    ...
                    <div className="dropdown">
                        ...
                        >
                        ...
                        }
                            {
                                user ? 
                                    <li>
                                        <div className="dropdown sm:dropdown-right md:dropdown-right dropdown-right "><img src={dbuser?.img} className="w-8 rounded-full" alt="" />
                ...
                <div className="navbar-end hidden lg:flex">
                    <ul className="menu menu-horizontal p-0">
                        ...
                        }
                        {
                                user ? 
                                    <li>
                                        <div className="dropdown dropdown-hover dropdown-left"><img src={dbuser?.img} className="w-8 rounded-full" alt="" />
  <ul tabindex="0" className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
    <li> <Link to="/dashboard">Profile</Link> </li>
    <li><button onClick={handleLogout}>SignOut</button></li>
  </ul>
