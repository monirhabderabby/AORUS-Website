        ...
        <div className="px-12">
            <section>
                <div class="hero min-h-screen">
                    <div class="hero-content flex justify-center flex-col lg:flex-row-reverse">
                        <img
                            ...
                            class="lg:max-w-lg rounded-lg shadow-2xl" alt="img"
                        />
                        <div className="text-left lg:min-w-lg">
                            ...
                            <button class="btn btn-primary">Check my Expertice</button>
                        </div>
                    </div>
                </div>
            </section>
